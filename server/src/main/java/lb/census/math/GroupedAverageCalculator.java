...
public class GroupedAverageCalculator implements AverageCalculator {
    ...
    public GroupedAverageCalculator() {
    }

    public GroupedAverageCalculator(int groupSize, int scale) {
